<nav class="navigation">
    ...
    <div class="navigation-items">
        ...
        @auth()
            @if(request()->routeIs('available-tickets')) <x-button type="button" class="navigation-item active btn btn-green rounded-full" title="{{__('Buy Ticket')}}"><span class="fa fa-ticket sm:mr-1"></span><span class="hidden sm:block">{{__('Buy Ticket')}}</span></x-button>
            @else <x-button tag="a" href="{{route('available-tickets')}}" class="navigation-item btn btn-green rounded-full" title="{{__('Buy Ticket')}}"><span class="fa fa-ticket sm:mr-1"></span><span class="hidden sm:block">{{__('Buy Ticket')}}</span></x-button>@endif
