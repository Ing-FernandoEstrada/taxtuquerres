<div>
    ...
    <div class="flex justify-end mb-4">
        <x-button type="button" class="btn btn-red" data-toggle="modal" data-target="#createCategoryForm" wire:click="openForm" title="{{__('New Category')}}"><span class="fa fa-plus"></span>{{__("New Category")}}</x-button>
    </div>
