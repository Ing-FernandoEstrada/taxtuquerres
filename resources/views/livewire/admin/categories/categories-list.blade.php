<div>
    ...
    <div class="flex justify-end mb-4">
        <x-button type="button" class="btn btn-green" data-toggle="modal" data-target="#modalCategoryForm" wire:click="openForm" title="{{__('New Category')}}"><span class="fa fa-plus"></span>{{__("New Category")}}</x-button>
    </div>
