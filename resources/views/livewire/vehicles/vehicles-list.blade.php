<div>
    ...
    <div class="flex justify-end">
        <x-button type="button" class="btn btn-red" data-toggle="modal" data-target="#modalUserForm" wire:click="openForm"><span class="fa fa-user-plus mr-1"></span>{{__('New Vehicle')}}</x-button>
    </div>
            ...
            @foreach($vehicles as $vehicle)
                <tr>
                    ...
                    <td data-label="{{__('Actions')}}">
                        <x-button type="button" class="btn btn-white" data-toggle="modal" data-target="#modalUserForm" wire:click="openForm({{$vehicle->id}})" title="{{__('Edit')}}"><span class="fa fa-edit"></span></x-button>
                       </td>
                </tr>
            @endforeach
            </tbody>
